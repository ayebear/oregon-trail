const splitPaths = {
	...
	theDalles: {
		description: "You Arrive at the Dalles, the last stop before Oregon. You can choose to raft down the columbia river to save some distance or play it safe and take the Barlow Toll Road",
		choices: [
			{
